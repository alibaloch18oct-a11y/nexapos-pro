...
const bottomModules = [
  { key: "orders", openKey: "orders", name: "Orders", icon: "📋", bg: "linear-gradient(135deg,#e5e7eb,#94a3b8)", dark: true },
  { key: "dispatch", openKey: "drive_thru_queue", name: "Dispatch", icon: "📍", bg: "linear-gradient(135deg,#22c55e,#06b6d4)", dark: true },
  { key: "attendance", openKey: "staff", name: "Attendance", icon: "🕘", bg: "linear-gradient(135deg,#ec4899,#8b5cf6)" },
  { key: "staff", openKey: "staff", name: "Staff", icon: "👥", bg: "linear-gradient(135deg,#bae6fd,#60a5fa)", dark: true },
  { key: "cashier", openKey: "staff", name: "Cashier", icon: "💳", bg: "linear-gradient(135deg,#ccfbf1,#2dd4bf)", dark: true },
  { key: "kds", openKey: "kds", name: "KDS", icon: "🖥️", bg: "linear-gradient(135deg,#94a3b8,#475569)" },
  { key: "reports", openKey: "analytics", name: "Reports", icon: "📈", bg: "linear-gradient(135deg,#ffffff,#c4b5fd)", dark: true },
  ...
  { key: "inventory", openKey: "inventory", name: "Inventory", icon: "📦", bg: "linear-gradient(135deg,#f59e0b,#ea580c)" },
  { key: "discounts", openKey: "discounts", name: "Discounts", icon: "🏷️", bg: "linear-gradient(135deg,#06b6d4,#7c3aed)" },
  { key: "customers", openKey: "customers", name: "Customers", icon: "🎁", bg: "linear-gradient(135deg,#22c55e,#15803d)" }
];
...
export default function ClientDashboard({ token, session, onOpenModule }) {
  ...
  function openMode(mode) {
    onOpenModule({
      ...
      name: mode.name,
      description: `${mode.name} POS mode`
    });
  }

  function openBottomModule(item) {
    onOpenModule({
      key: item.openKey,
      name: item.name,
      ...
      <style>
        {`
          ...
          .nexa-epos-dashboard::after {
            ...
            filter: blur(3px);
            animation: dashboardOrb 8s ease-in-out infinite;
            pointer-events: none;
          }

          @keyframes dashboardOrb {
            0%,100% { transform: translateY(0) scale(1); opacity: .55; }
            50% { transform: translateY(-18px) scale(1.08); opacity: .85; }
          }
          ...
          <div className="stats-strip">
            {topStats.map((item) => (
              <div className="stat-chip" key={item.label}>
                <div className="stat-chip-icon">{item.icon}</div>
                <div>
